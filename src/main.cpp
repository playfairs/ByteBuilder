...
uint64_t parseSize(const std::string& sizeStr) {
    ...
    if (unit.empty() || unit == "B") {
        ...
        return static_cast<uint64_t>(value * 1000.0 * 1000 * 1000 * 1000);
    } else if (unit == "TIB") {
        return static_cast<uint64_t>(value * 1024.0 * 1024 * 1024 * 1024);
    } else if (unit == "PB") {
        return static_cast<uint64_t>(value * 1000.0 * 1000 * 1000 * 1000 * 1000);
    } else if (unit == "PIB") {
        return static_cast<uint64_t>(value * 1024.0 * 1024 * 1024 * 1024 * 1024);
    } else if (unit == "EB") {
        return static_cast<uint64_t>(value * 1000.0 * 1000 * 1000 * 1000 * 1000 * 1000);
    } else if (unit == "EIB") {
        return static_cast<uint64_t>(value * 1024.0 * 1024 * 1024 * 1024 * 1024 * 1024);
    } else if (unit == "ZB") {
        return static_cast<uint64_t>(value * 1000.0 * 1000 * 1000 * 1000 * 1000 * 1000 * 1000);
    } else if (unit == "ZIB") {
        return static_cast<uint64_t>(value * 1024.0 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024);
    } else if (unit == "YB") {
        return static_cast<uint64_t>(value * 1000.0 * 1000 * 1000 * 1000 * 1000 * 1000 * 1000 * 1000);
    } else if (unit == "YIB") {
